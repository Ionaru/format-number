...
Thank you so much for your interest in contributing to format-number!


## Asking questions, suggesting wonderful ideas or reporting bugs

You can [submit an issue️](https://github.com/Ionaru/format-number/issues) on this GitHub repository.
...
```bash
git clone https://github.com/Ionaru/format-number.git
cd format-number
```
...
1. [Create a fork of this project](https://github.com/Ionaru/format-number/fork).
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/format-number.git`.
3. Add the original repository as remote to keep it up-to-date: `git remote add upstream https://github.com/Ionaru/format-number.git`.
